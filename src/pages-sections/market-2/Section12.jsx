import { Box, Card, Container, Grid, List, ListItem, styled } from "@mui/material";
    ...
    <Container sx={{ px: { xs: 1, sm: 2 } }}>
      <Grid container spacing={{ xs: 2, sm: 3 }}>
        <Grid item md={3} xs={12}>
          ...
          >
            <H3 fontSize={{ xs: 18, sm: 20, md: 24 }}>{Section2Name&&Section2Name?Section2Name:"Category Name"}</H3>
